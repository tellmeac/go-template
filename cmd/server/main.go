// Copyright 2022 Alexander Lipatov
//
...
import (
	...
	"github.com/tellmeac/go-template/internal/infrastructure"
...
func main() {
	...
	client, err := infrastructure.NewDatabaseClient(cfg)
	if err != nil {
		log.Fatal().Err(err).Msg("Failed to setup database connection")
	}

	dao := infrastructure.NewDAO(client)
